...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-dev-key-change-in-prod-please")
...
# How long an idempotency key lives (24h in seconds)
IDEMPOTENCY_KEY_TTL_SECONDS = 86400

# Payout processing simulation
PAYOUT_SUCCESS_RATE = 0.70   # 70% success
PAYOUT_FAIL_RATE = 0.20      # 20% fail
# remaining 10% → stuck in processing
